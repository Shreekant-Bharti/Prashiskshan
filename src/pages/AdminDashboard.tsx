...
const DUMMY_PENDING_USERS = {
  students: [
    { id: 1, name: 'Sneha Kumari', email: 'sneha@college.edu', college: 'MIT Manipal', course: 'B.Tech CSE', semester: '6th' },
    { id: 2, name: 'Ravi Kumar', email: 'ravi@college.edu', college: 'VIT Chennai', course: 'B.Tech ECE', semester: '4th' },
    { id: 3, name: 'Priya Sharma', email: 'priya@college.edu', college: 'BITS Pilani', course: 'B.Tech IT', semester: '5th' }
  ],
  faculty: [
    { id: 1, name: 'Dr. Sharma', email: 'sharma@college.edu', college: 'MIT Manipal', department: 'Computer Science', experience: '10 years' },
    { id: 2, name: 'Prof. Verma', email: 'verma@college.edu', college: 'VIT Chennai', department: 'Electronics', experience: '8 years' }
  ],
  industry: [
    { id: 1, name: 'Infosys Ltd', email: 'hr@infosys.com', type: 'IT Services', size: '500+', location: 'Bangalore' },
    { id: 2, name: 'TCS', email: 'careers@tcs.com', type: 'IT Consulting', size: '500+', location: 'Mumbai' }
  ]
};
...
const DUMMY_FEEDBACK = [
  { id: 1, type: 'complaint', user: 'Ravi Kumar', message: 'Login issue - unable to access student portal', status: 'pending' },
  { id: 2, type: 'feedback', user: 'Dr. Sharma', message: 'Internship listings not visible in faculty dashboard', status: 'pending' },
  { id: 3, type: 'complaint', user: 'Priya Sharma', message: 'Application submission failed multiple times', status: 'resolved' }
];

const DUMMY_HISTORY = [
  { id: 1, action: 'Student Sneha Kumari approved', date: 'Oct 2, 2025', type: 'approval' },
  { id: 2, action: 'Industry Infosys internship rejected', date: 'Sep 28, 2025', type: 'rejection' },
  { id: 3, action: 'Faculty Dr. Sharma approved', date: 'Sep 25, 2025', type: 'approval' },
  { id: 4, action: 'Notice published: New internship guidelines', date: 'Sep 20, 2025', type: 'notice' }
];
...
const AdminDashboard = () => {
  ...
  const [activeUsers, setActiveUsers] = useState({ students: [], faculty: [], industry: [] });
  const [rejectedUsers, setRejectedUsers] = useState({ students: [], faculty: [], industry: [] });
  const [pendingInternships, setPendingInternships] = useState(DUMMY_INTERNSHIPS);
  ...
  const [notices, setNotices] = useState([
    {
      ...
      content: "Major placement drive scheduled for next month with 50+ companies participating.",
      priority: "high" as const,
  ...
  const [feedbacks, setFeedbacks] = useState([
    {
      ...
      content: "The platform is very user-friendly and helped me find a great internship opportunity.",
      rating: 5,
      category: "Platform",
      priority: "low" as const,
  ...
  const [adminProfile, setAdminProfile] = useState({
    ...
    avatar: "",
    permissions: ["User Management", "Content Management", "System Settings", "Reports", "Security"],
    preferences: {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-500">Please login to access admin dashboard</p>
        </div>
      </div>
    );
  }
    ...
    <div className="min-h-screen bg-gradient-to-br from-violet-50 via-blue-50 to-cyan-50">
          ...
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500">Campus2Career - Prashiskshan</p>
              </div>
            </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        >
          ...
          <p className="opacity-90">Manage your campus internship ecosystem efficiently</p>
        </motion.div>
